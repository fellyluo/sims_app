...
@section('content')
<div x-data="payForm()" class="space-y-5 max-w-2xl mx-auto">
    ...
    <div class="card p-5 text-center bg-gradient-to-br from-primary/10 to-transparent">
        <p class="text-xs text-slate-500 dark:text-slate-400 uppercase tracking-wide">{{ $payable ? 'Total yang harus dibayar' : 'Nominal' }}</p>
        ...
        @if($pembayaran->jatuh_tempo && $payable)
