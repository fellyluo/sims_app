@extends('layouts.app')
@section('title', 'Riwayat Pengajuan Poin Saya')

@section('content')
<div class="space-y-5">
    <a href="{{ route('poin.guru.index') }}" class="inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-primary"><i data-lucide="arrow-left" class="w-4 h-4"></i> Kembali</a>
    <div>
        <h1 class="page-title">Riwayat Pengajuan Poin Saya</h1>
        <p class="text-sm text-slate-500 dark:text-slate-400 mt-0.5">Status pengajuan poin yang pernah Anda ajukan</p>
    </div>
